...
//    public void addAlanine(Protein protein, boolean isLast) {
//        if (isLast) {
//            protein.atomBuffer.append("CCCOONHHHHHH");
//            protein.atomCount += 12;
//
//            int atomIdx = protein.atomCount;
//            protein.bondList.add(String.format("%d %d", protein.terminusC, atomIdx + 5));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 1));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 6));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 7));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 8));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 2));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 5));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 9));
//            protein.bondList.add(String.format("%d %d", atomIdx + 2, atomIdx + 3));
//            protein.bondList.add(String.format("%d %d", atomIdx + 2, atomIdx + 3));
//            protein.bondList.add(String.format("%d %d", atomIdx + 2, atomIdx + 4));
//            protein.bondList.add(String.format("%d %d", atomIdx + 4, atomIdx + 10));
//            protein.bondList.add(String.format("%d %d", atomIdx + 5, atomIdx + 11));
//
//            protein.complete = true;
//        } else {
//            protein.atomBuffer.append("CCCONHHHHH");
//            protein.atomCount += 10;
//
//            int atomIdx = protein.atomCount;
//            protein.bondList.add(String.format("%d %d", protein.terminusC, atomIdx + 4));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 1));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 5));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 6));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 7));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 2));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 4));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 8));
//            protein.bondList.add(String.format("%d %d", atomIdx + 2, atomIdx + 3));
//            protein.bondList.add(String.format("%d %d", atomIdx + 2, atomIdx + 3));
//            protein.bondList.add(String.format("%d %d", atomIdx + 4, atomIdx + 10));
//
...
//    }
//
//    public void addArginine(Protein protein, boolean isLast) {
//        if (isLast) {
//            protein.atomBuffer.append("CCCCOONCNCNNHHHHHHHHHHHHH");
//            protein.atomCount += 25;
//
//            int atomIdx = protein.atomCount;
//            protein.bondList.add(String.format("%d %d", protein.terminusC, atomIdx + 11));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 1));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 7));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 12));
//            protein.bondList.add(String.format("%d %d", atomIdx, atomIdx + 13));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 2));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 14));
//            protein.bondList.add(String.format("%d %d", atomIdx + 1, atomIdx + 15));
//            protein.bondList.add(String.format("%d %d", atomIdx + 2, atomIdx + 3));
//            protein.bondList.add(String.format("%d %d", atomIdx + 2, atomIdx + 6));
//            protein.bondList.add(String.format("%d %d", atomIdx + 3, atomIdx + 4));
//            protein.bondList.add(String.format("%d %d", atomIdx + 4, atomIdx + 10));
//            protein.bondList.add(String.format("%d %d", atomIdx + 5, atomIdx + 11));
//
//            protein.complete = true;
...
//    public static Protein initProtein(AminoAcid aminoAcid) {
//        Protein protein = new Protein();
//
//        return protein;
//    }

    public void addAminoAcidLast() {
